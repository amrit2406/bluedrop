        ...
        >
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6">
              Ready to Experience <span className="text-cyan-200">Pure Water</span>?
            </h2>
          </motion.div>
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Join <span className="font-semibold">thousands of satisfied customers</span> who trust BlueDrop for their water purification needs.
          </motion.p>
